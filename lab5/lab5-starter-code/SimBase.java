...
public class SimBase {
    ...
    public int execute(byte instruction, byte oldPC) {
		...
		byte newPC = oldPC;
		int reg1Index = get_bits(instruction,2,4); //address
		int reg2Index = get_bits(instruction,0,2); //address
		if(get_bits(instruction,7,8)!=1){
			switch (get_bits(instruction,4,7)){
				case 0:
				R[reg1Index]=R[reg2Index];
				newPC++;
				break;
				case 1:
				R[reg1Index]+=R[reg2Index];
				...
				break;
				case 2:
				R[reg1Index]=(byte)(R[reg1Index]&R[reg2Index]);
				newPC++;
				break;
				case 3:
				R[reg1Index]=M[R[reg2Index]&0xFF];
				newPC++;
				break;
				case 4:
				M[R[reg2Index]&0xFF]=R[reg1Index];
				newPC++;
				break;
				case 5:
				switch (R[reg2Index]){
					case 0:
					R[reg1Index]=(byte)(~R[reg1Index]);
					break;
					case 1:
					R[reg1Index]=(byte)(-R[reg1Index]);
					break;
				...
				switch (R[reg2Index]){
					case 0:
					R[reg1Index]=M[newPC+1];
					break;
					case 1:
					R[reg1Index]+=M[newPC+1];
					break;
					case 2:
					R[reg1Index]=(byte)(R[reg1Index]&M[newPC+1]);
					break;
					case 3:
					R[reg1Index]=M[M[newPC+1]];
					break;
				}
				newPC++;
				break;
